...
public class DTNHost implements Comparable<DTNHost> {
	...
	private double curBatteryLevel; // Nivel de Bateria Atual gerada no SimScenario
	...
	public DTNHost(List<MessageListener> msgLs,
			...
			MovementModel mmProto, MessageRouter mRouterProto, double currentBatteryLevel) {
		this.comBus = comBus;
		...
		this.curBatteryLevel = currentBatteryLevel;
	 ...
	 * @see Comparable#compareTo(Object)
	 */
	public double getCurrentBatteryLevel() {return this.curBatteryLevel;}

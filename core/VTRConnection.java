 ...
 */
public class VTRConnection extends Connection {
    private int speed;
     ...
     * @param connectionRange Transfer speed of the connection (Bps) when the connection is initiated
     */
    public VTRConnection(DTNHost fromNode, NetworkInterface fromInterface,
                         DTNHost toNode, NetworkInterface toInterface, int connectionSpeed, double connectionRange) {
        super(fromNode, fromInterface, toNode, toInterface);
        this.speed = connectionSpeed;
        this.tRange = connectionRange;
    ...
    /**
     * returns the current transmit range of the connection
     */
